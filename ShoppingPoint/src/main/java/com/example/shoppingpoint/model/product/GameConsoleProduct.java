...
public class GameConsoleProduct extends Product {
    ...
    public GameConsoleProduct(String name, Number price, Number discountedPrice, Integer quantity, StatusType status, ConsoleType consoleType, boolean digitalOnly) {
        setName(name);
        setPrice(price);
